...
public class StringUtils {
     ...
     * @return
     */
    public static String paddingLeft(String srcStr,int length,String padding){
        if(TextUtils.isEmpty(srcStr) || TextUtils.isEmpty(padding)){
            return null;
        }
     ...
     * @return
     */
    public static String paddingRight(String srcStr,int length,String padding){
        if(TextUtils.isEmpty(srcStr) || TextUtils.isEmpty(padding)){
            return null;
        }
        while (srcStr.length() < length) {
