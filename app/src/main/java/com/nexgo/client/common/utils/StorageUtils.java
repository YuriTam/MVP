...
public class StorageUtils {
    ...
    public static List<StorageEntity> getStorageData(Context pContext) {
        ...
        try {
            ...
            List<StorageEntity> list = new ArrayList<>();
            for (int i = 0; i < length; i++) {
                ...
                if (mGetState != null) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                        ...
                        e(TAG, "externalStorageDirectory==" + externalStorageDirectory);
                    }
                }
                long totalSize = 0;
                long availaleSize = 0;
                ...
                StorageEntity storageBean = new StorageEntity();
     ...
     * @return
     */
    public static boolean isExternalSDCardExist(StorageEntity storageEntity){
        if (storageEntity == null){
            return false;
        }
        return storageEntity.getMounted().equalsIgnoreCase("mounted");
    }
    ...
    public static String fmtSpace(long space) {
        ...
        if (gbValue >= 1) {
            ...
            LogUtils.show(TAG,"GB gb value = {}", mbValue);
            if (mbValue >= 1) {
